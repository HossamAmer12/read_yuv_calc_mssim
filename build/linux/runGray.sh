...
input_yuv=/media/h2amer/MULTICOM102/103_HA/MULTICOM103/set_yuv/pics/1/ILSVRC2012_val_00000034_504_368_Y.yuv

QP=$1
recons_hevc=/media/h2amer/MULTICOM102/103_HA/MULTICOM103/set_yuv/Seq-RECONS/1/ILSVRC2012_val_00000034_504_368_Y_${QP}_1.yuv
bit_hevc=/media/h2amer/MULTICOM102/103_HA/MULTICOM103/set_yuv/Seq-265/1/ILSVRC2012_val_00000034_504_368_Y_${QP}_1.265
...
# For ffmpeg
recons_ffmpeg=/media/h2amer/MULTICOM102/103_HA/MULTICOM103/set_yuv/Seq-RECONS-ffmpeg/1/ILSVRC2012_val_00000034_504_368_Y_${QP}.yuv
bit_ffmpeg=/media/h2amer/MULTICOM102/103_HA/MULTICOM103/set_yuv/Seq-265-ffmpeg/1/ILSVRC2012_val_00000034_504_368_Y_${QP}.265
...
# To 265 with x265
# time ffmpeg -loglevel panic -y -f rawvideo -pix_fmt gray -s:v 504x336  -i $input_yuv -c:v libx265 -crf $QP -f hevc -preset ultrafast $bit_ffmpeg
time ffmpeg -y -f rawvideo -pix_fmt gray -s:v 504x368  -i $input_yuv -c:v libx265 -crf $QP -f hevc -preset ultrafast $bit_ffmpeg
